...
## 💾 9. Aiven OpenSearch Cluster Management
...
2. **Check Cluster Health**:
   ...
   curl http://localhost:8000/api/v1/health
   ```
3. **Local PDF Space**: If your disk fills up, you can safely delete PDFs in `data/downloads/`. All search text and vectors are already stored in your cloud vector store.
